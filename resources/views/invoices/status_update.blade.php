                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input class="form-control fc-datepicker" name="Section"
                                       type="text" value="{{ $invoices->sections->section_name }}" required readonly>
                            </div>

                            <div class="col">
                                <label for="inputName" class="control-label">المنتج</label>
                                <input class="form-control fc-datepicker" name="product"
                                       type="text" value="{{ $invoices->product }}" required readonly>
                            </div>
