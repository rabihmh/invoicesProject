                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        @can('الفواتير الغير مدفوعة')
                            <li><a class="slide-item" href="{{ url('Invoice_UnPaid') }}">الفواتير الغير المدفوعة</a>
                            </li>
                        @endcan
                        @can('الفواتير المدفوعة جزئيا')
                            <li><a class="slide-item" href="{{ url('Invoice_Partial') }}">الفواتير المدفوعة جزئيا</a>
                            </li>
                        @endcan
                        @can('ارشيف الفواتير')

                            <li><a class="slide-item" href="{{ route('invoices.archive') }}">أرشيف الفلااتير </a></li>
                        @endcan
